            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-xs-12 col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group">
                                <select multiple="multiple" class="custom-select" name="equipamentos[]" id="equipamentosSelecionados" size="10">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" name="ano" value="{{ $veiculo->ano }}" class="form-control" placeholder="Digite o ano do veículo ...">
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
